...
import "../styles/yourActivity.css";
import { Router, Route, Link, browserHistory } from 'react-router';

// <Content />

export class YourActivity extends React.Component<{}, {}> {
  render() {
    return (
      <div id="wrapper" className="home">
        <div id="overlay"></div>
        <div id="popup-window">
          <Link to="home2" ><img id="close-button" src="../public/images/close.png"></img></Link>
        ...
        <div id ="home">
          <div className="inline center-div">
            ...
            <div id="your-activity">
              <Link to="your-activity"><img className="" src="../public/images/your.png"></img></Link>
            </div>
          </div>
